...
_Last updated: 2026-07-01_ — H1–H4 done: full React frontend (intake stepper, COPE review, risk dossier, event timeline + approve/export). I1 done (synthetic submissions). I2 done (seed script + demo runbook).
